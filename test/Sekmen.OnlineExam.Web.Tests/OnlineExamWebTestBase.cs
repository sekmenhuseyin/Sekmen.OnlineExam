...
{
    public abstract class OnlineExamWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static OnlineExamWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(OnlineExamWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<OnlineExamDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<OnlineExamDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<OnlineExamDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<OnlineExamDbContext, Task<T>> func)
        {
            T result;
